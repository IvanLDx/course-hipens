		...
		<View style={styles.card}>
			...
			{!order.isPaid && (
				<View style={styles.paymentSection}>
					{isLoadingPayPalConfig ? (
						...
						<Text style={styles.errorText}>Error loading PayPal configuration</Text>
					) : (
						<TouchableOpacity
							style={[
								styles.button,
								(isCreatingPayPalOrder || isCapturingPayPalOrder || isPayingOrder || !order || !paypalConfig?.clientId) && styles.buttonDisabled
							]}
							onPress={onPayWithPayPal}
							disabled={isCreatingPayPalOrder || isCapturingPayPalOrder || isPayingOrder || !order || !paypalConfig?.clientId}
						>
							{isCreatingPayPalOrder || isCapturingPayPalOrder || isPayingOrder ? (
			...
			{userInfo && userInfo.isAdmin && order.isPaid && !order.isDelivered && (
				<View style={styles.adminActionSection}>
					...
					>
						{isLoadingDeliver ? <ActivityIndicator color={Colors.white} /> : <Text style={styles.buttonText}>Mark As Delivered</Text>}
					</TouchableOpacity>
				</View>
			)}
