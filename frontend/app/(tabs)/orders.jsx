import { StyleSheet, Text, View, ActivityIndicator, SafeAreaView, Platform, FlatList, TouchableOpacity } from 'react-native';
				...
				<FlatList
					...
					renderItem={({ item: order, index }) => (
						<View style={styles.tableRow}>
							...
							<Text style={[styles.cell, { flex: 1 }]}>${order.totalPrice}</Text>
